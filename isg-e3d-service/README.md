...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="com.isg.e3d.services.isg_e3d_service.controller"/>` and `<mvc:annotation-driven/>` are used to register both the non-rest and rest controllers.
...
4. This will deploy `target/isg-e3d-service.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/isg-e3d-service/>.
